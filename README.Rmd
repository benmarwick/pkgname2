...
You can download the compendium as a zip from from this URL: <https://github.com/benmarwick/pkgname2/archive/master.zip>

Or you can install this compendium as an R package, pkgname2, from GitHub with:
